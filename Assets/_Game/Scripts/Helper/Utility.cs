...
{
    public static Dictionary<GoalItemType, int> GoalItemListToDict(List<GoalItemEntry> source)
    {
        Dictionary<GoalItemType, int> result = new();
        ...
        {
            GoalItemType type = (GoalItemType)entry.goalItem;
            result[type] = entry.count;
        }
    ...
    public static List<GoalItemEntry> GoalItemDictToList(Dictionary<GoalItemType, int> source)
    {
        List<GoalItemEntry> result = new();
